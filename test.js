...
ta.aroon_up([5, 4, 5, 2], 3).then((aroon_up) => { try { assert.deepEqual(aroon_up, [66.66666666666667, 33.333333333333336]); } catch(e) { console.error('Test failed @ aroon up \n'); }});
ta.aroon_down([2, 5, 4, 5], 3).then((aroon_down) => { try { assert.deepEqual(aroon_down, [66.66666666666667, 33.333333333333336]); } catch(e) { console.error('Test failed @ aroon down \n'); }});
ta.aroon_osc([2, 5, 4, 5], 3).then((aroon_osc) => { try { assert.deepEqual(aroon_osc, [-33.333333333333336, 33.333333333333336]); } catch(e) { console.error('Test failed @ aroon osc \n'); }});
...
console.log("If you see only this message, that means all is good!")